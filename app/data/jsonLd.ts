...
export function organizationJsonLd() {
  return {
    ...
    url: site.url,
    logo: `${site.url}/logo-banner.png`,
    image: `${site.url}/logo-banner.png`,
    ...
    sameAs: [site.social.facebook, site.social.instagram, site.social.twitter].filter(Boolean),
...
export function localBusinessJsonLd() {
  return {
    ...
    name: site.name,
    alternateName: "Mainstream Green Solar",
    description: site.longDescription,
    url: site.url,
    telephone: site.phone,
    email: site.email,
...
export function websiteJsonLd() {
  return {
    ...
    url: site.url,
    name: site.name,
    alternateName: "Mainstream Green Energy Solutions Solar",
    description: site.longDescription,
