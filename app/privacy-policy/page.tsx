...
export const metadata: Metadata = {
  title: "Privacy policy | Green Sunsure Energy",
  description:
    "How Green Sunsure Energy collects, uses, and protects your personal information when you use our website, request a quote, or buy from our store.",
