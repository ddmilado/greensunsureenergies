...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden bg-[var(--ink-950)] px-4 pb-20 pt-36 text-white md:px-8 md:pb-28 md:pt-44">
      ...
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1fr_0.72fr] lg:items-end">
        <div className="relative z-10">
          <p className="mb-5 text-sm font-semibold uppercase tracking-[0.24em] text-[var(--solar-lime)]">{kicker}</p>
          <h1 className="max-w-5xl text-balance text-5xl font-semibold leading-[0.92] tracking-[-0.07em] md:text-7xl">
            {title}
          </h1>
          <p className="mt-7 max-w-2xl text-lg leading-8 text-white/72">{text}</p>
