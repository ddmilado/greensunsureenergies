...
export const metadata: Metadata = {
  title: "Contact Damdavy Technologies | Get a Solar Quote",
  description:
    "Request a free solar quote or talk to the Damdavy Technologies team about installation, batteries, and maintenance in Ogun State, Lagos, and Nigeria.",
  alternates: { canonical: "/contact-us" },
  openGraph: {
    title: "Contact Damdavy Technologies | Get a Solar Quote",
    description: "Request a free quote or call the Damdavy solar team in Ogun State, Nigeria.",
    url: "/contact-us",
    type: "website",
  },
};
  ...
  return (
    <main id="main" className="overflow-x-hidden">
      ...
      <section className="px-4 py-24 md:px-8 md:py-36">
        <SectionHeading eyebrow="Reach Damdavy" title="A quote call, a site visit, or a direct message.">
