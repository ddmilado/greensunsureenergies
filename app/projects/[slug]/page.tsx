...
export async function generateMetadata({ params }: { params: Promise<Params> }): Promise<Metadata> {
  ...
  return {
    title: `${project.title} | Damdavy Project`,
    description: project.excerpt ?? `Damdavy ${project.category.toLowerCase()} solar installation case study.`,
        ...
        {related.length > 0 && (
          <section className="bg-[var(--ink-950)] px-4 py-24 text-white md:px-8 md:py-28">
            <div className="mx-auto max-w-6xl">
              <h2 className="text-2xl font-semibold tracking-[-0.04em] md:text-3xl">More Damdavy projects</h2>
